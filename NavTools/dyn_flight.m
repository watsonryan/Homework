...
segparf16 = [5 600  200 NaN NaN 90 NaN 1;  % Level flight for 600 sec
             ...
             9 NaN NaN NaN -3 45 -1.965 0.005;  % Turn to heading of 45 deg
             8 NaN NaN NaN 0 NaN NaN 0.005;  % Pitch and roll back to level
             5 1  200 NaN NaN 45 NaN 0.005;  % Level flight for 1 sec
             5 30  200 NaN NaN 45 NaN 1;  % Level flight for 30 sec
             8 NaN NaN NaN 3 NaN NaN 0.005;  % Pitch and roll into a turn
             9 NaN NaN NaN 3 135 2.01 0.005;  % Turn to heading of 135 deg
             8 NaN NaN NaN 0 NaN NaN 0.005;  % Pitch and roll back to level
             5 1  200 NaN NaN 135 NaN 0.005;  % Level flight for 1 sec
             5 30  200 NaN NaN 135 NaN 1;  % Level flight for 30 sec
             8 NaN NaN NaN -3 NaN NaN 0.005;  % Pitch and roll into a turn
             9 NaN NaN NaN -3 45 -1.9552 0.005;  % Turn to heading of 45 deg
             8 NaN NaN NaN 0 NaN NaN 0.005;  % Pitch and roll back to level
             5 1  200 NaN NaN 45 NaN 0.005;  % Level flight for 1 sec
             5 30  200 NaN NaN 45 NaN 1;  % Level flight for 30 sec
             8 NaN NaN NaN 3 NaN NaN 0.005;  % Pitch and roll into a turn
             ...
             5 600  200 NaN NaN 90 NaN 1];  % Level flight for 600 sec
...
%%save dyn_flt_dat -V6     % use for MATLAB version 7.x
save dyn_flt_dat       % use for MATLAB version 6.x

figure
plot(profile(:,1)*0.001,profile(:,2)*0.001)
axis equal
title('DYN FLIGHT: Flight Path Generated By PROGENF16')
xlabel('east (km)')
ylabel('north (km)')
grid
...
subplot(311)
plot(time,profile(:,4))
title('DYN FLIGHT: Velocity Components')
