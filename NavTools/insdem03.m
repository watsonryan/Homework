%
%   insdem03.m      Same as insdem02.m but the simulation
%                   time steps half the size.  As a result,
%                   the errors due to the imperfect
%                   numerical integration are decreased.
%
...
text(60,0.003,'north')
text(74,0,'up')
text(10,0.015,'Sampling rates are double those used in INSDEM02')
