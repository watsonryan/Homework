%
%   insdem07.m
%      Static user with east gyro bias
%
...
e_gyro_bias = 0.001*dph2rps;   % 0.001 deg/hr east gyro bias
n_accel_bias = 0;
deltat = 10;
...
acc_e_gyro_bias = e_gyro_bias*deltat;   % accumulate the bias to form the
%                                       % associated component of delta-theta 

dtherr = [0 acc_e_gyro_bias 0];   % Form the delta-theta error vector
...
title('INSDEM07: 0.001 deg/hr East Gyro Bias')
...
title('INSDEM07:  Euler Angle Errors')
ylabel('error in arc-seconds')
xlabel('time in hours')
text(2.3,-1.2,'pitch')
text(1,0.6,'roll')
