...
%
%   Copyright (c) 2002-2010    Michael S. Braasch / GPSoft LLC
%
%  Revisions:  October 2010: Fixed bug in assignment of UTC_A0 and UTC_A1
%
...
while 1   % this is the numeral '1'
    ...
    if len > 68,
       if line(61:69) == 'DELTA-UTC',
           UTC_A0 = str2num(line(4:22));
           UTC_A1 = str2num(line(23:42));
