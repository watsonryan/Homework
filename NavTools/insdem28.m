...
%   insdem28.m
%
%   Same as INSDEM27 but now with non-zero sensor errors
%
%    04/11/05
%    M. & S. Braasch
%    GPSoft LLC
...
axis([0 2 -0.06 0.02])
title('INSDEM28 - Position and Velocity Errors')
...
subplot(212)
plot(time/3600,vel_l(:,1:2)-vel_l_0(:,1:2))
...
%axis([0 9 -0.1 0.1])
title('INSDEM28 - Euler Angle Errors')
ylabel('error in degrees')
xlabel('time in hours')
text(1.05,-0.01,'ROLL')
text(0.6,0.01,'PITCH')
...
title('INSDEM28 - Horizontal Position Error')
