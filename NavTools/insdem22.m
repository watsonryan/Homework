...
%   insdem22.m
%
%   Here we solve the INSDEM20.M problem by inserting
%   short (1 sec) straight segments with high rate
%   sampling (100 Hz) in between the dynamic maneuvers
%   the low-rate straight segments.
%
%   02/28/05
%
%
...
segparf16 = [5 20  200 NaN NaN 90 NaN 0.01;  % Level accel for 20 sec up to 200 meters/sec
             ...
             9 NaN NaN NaN -3 270 -1.59 0.01;  % Turn to heading of 270 deg
...
axis equal
title('Flight Path Generated By PROGENF16')
xlabel('east (meters)')
ylabel('north (meters)')
zlabel('up (meters)')
grid
