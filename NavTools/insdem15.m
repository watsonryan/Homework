%
%   insdem15.m
%      Great Circle Path INS Demo with Wander Azimuth (FREE AZIMUTH)
...
% JFK_deg = [40 -90];  % New York (JFK airport)
% JFK_rad = JFK_deg*pi/180;
% IST_deg = [40 92];         % Istanbul
% IST_rad = IST_deg*pi/180;
...
%
vertmech = 1;                             % FREE AZIMUTH VERTICAL MECHANIZATION
%
