%
%   insdem17.m
%      Great Circle Path INS Demo with Wander Azimuth (UNIPOLAR)
...
%
vertmech = 3;                             % UNIPOLAR VERTICAL MECHANIZATION
%
...
title('New York to Istanbul - UNIPOLAR MECHANIZATION')
ylabel('yaw, wander angle and heading (deg)')
xlabel('time in hours')
text(5,50,'YAW')
text(5,115,'HEADING')
text(2,-60,'WANDER ANGLE')
...
xlabel('time in hours')
text(6,110,'local-level-x')
text(5,195,'local-level-y')
text(0.5,230,'EAST')
text(7.5,-120,'NORTH')
