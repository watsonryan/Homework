%  sndemo39.m     Point Positioning with RINEX2 ephemeris and observation files
%                 C/A-Code pseudoranges are used; No IONO or TROPO
%                 corrections applied
%
...
xlabel('east error (m)')
text(-7,-3,'No atmospheric corrections applied')