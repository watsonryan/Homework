function [DCM_ll_I, omega_el_L] = lclevtmp(lat1,lat2,vx1,vx2,vy1,vy2,height1, ...
                        height2,td12,tdex,tdint,DCMel,vertmech,procflg,earthflg)
%LCLEVTMP      Special version of LCLEVUPD with Earth rate set to zero
%              (Used in conjunction with INSDEM05)
%
%	[DCM_ll_I,omega_el_L] = lclevtmp(lat1,lat2,vx1,vx2,vy1,vy2,height1, ...
%                 height2,td12,tdex,tdint,DCMel,vertmech,procflg,earthflg)
%
%   INPUTS
...
omega_ie_E = [0 0 0]';  % this is used for testing purposes only
