...
segparf16 = [5 20  200 NaN NaN 90 NaN 0.01;  % Level accel for 20 sec up to 200 meters/sec
             ...
             9 NaN NaN NaN -3 270 0 0.01;  % Turn to heading of 270 deg
...
axis equal
title('INSDEM18: Flight Path Generated By PROGENF16')
xlabel('east (meters)')
ylabel('north (meters)')
zlabel('up (meters)')
grid
...
subplot(311)
plot(time,profile(:,4))
title('INSDEM18: Velocity Components')
...
subplot(111)
plot(time_eulr,yaw)
title('INSDEM18:  Zoom View of Yaw Angle')
ylabel('yaw angle in deg')
xlabel('run time in seconds')
