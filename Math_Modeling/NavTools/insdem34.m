...
%   insdem34.m
%
%    Version 3 flight trajectory generator being used
%
%   - INS position/velocity/attitude updating demo
%   - Simplified F-16 model with feedback control
...
pitch0 = pitch;
yaw0 = yaw;
save dem34_0 est_alpha0 est_lat0 est_lon0 vel_l_0 roll0 pitch0 yaw0
...
xlabel('time in minutes')
text(0.25,-81.5,'Note that in both plots the true and')
text(0.25,-81.6,'computed routes overlay each other')

figure
plot(time/60,laterr*(180/pi)*3600,time/60,longerr*(180/pi)*3600)
title('INSDEM34:  Algorithm Errors')
