%
%   insdem10.m
%      Static user with initial north tilt
%
%      - All accel and gyro biases and 
%        initial velocity errors are set to zero
%

clear all
close all

n_tilt = (10/3600)*pi/180;  % 10 arc-second initial north tilt error
e_tilt = 0;
...
phi=0*pi/180 + n_tilt;            % North tilt corresponds to the
theta=0*pi/180 + e_tilt;          % aircraft roll axis in this case
psi=0*pi/180;                     % because aircraft is pointed north
...
title('INSDEM10: 10 Arc-Sec Initial North Tilt Error')
