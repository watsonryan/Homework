...
%   insdem20.m
%
%   Modification to INSDEM19
%
%   Here we sample the straight segments at just 1 Hz.
%   However, this will cause a transient in the free-inertial
%   updating program of several meters.  See INSDEM22.M for
...
segparf16 = [5 20  200 NaN NaN 90 NaN 0.01;  % Level accel for 20 sec up to 200 meters/sec
             ...
             6 NaN NaN -15   NaN 270 NaN 0.01; % Pitch down transition to 5 deg descent
...
axis equal
title('INSDEM20: Flight Path Generated By PROGENF16')
xlabel('east (meters)')
ylabel('north (meters)')
zlabel('up (meters)')
grid
...
subplot(311)
plot(time,profile(:,4))
title('INSDEM20: Velocity Components')
