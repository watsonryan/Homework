function parvec = parityvec(prvec,svxyzmat,initpos,tol)
%PARITYVEC	PARITYVEC computes the parity vector associated with
%           the overdetermined user position solution.
%       
...
%
%   NOTE:  This function was called 'RAIM' in earlier versions
%          of the toolbox
